...
## Per-user serialization to avoid interleaving of parts/answers
from services.concurrency import acquire_user_lock
...
async def handle_korneslov_query(message: types.Message, refs=None):
    ...
    ## Serialize full lifecycle for this user to avoid mixing answers/parts
    async with acquire_user_lock(uid):
